...
/*   Updated: 2025/10/30 16:53:41 by dansimoe         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	header = ft_lstnew(sub[1]);
	second = ft_lstnew(sub[2]);
	third = ft_lstnew(sub[3]);
	header->next = second;
	second->next = third;
	...
	header = ft_lstnew(sub2[1]);
	second = ft_lstnew(sub2[2]);
	third = ft_lstnew(sub2[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	{
		new = ft_lstnew(sub2[0]);
		ft_lstadd_front(&header, new);
		if (new)
		{
			t = 0;
	...
	header = ft_lstnew(sub3[1]);
	second = ft_lstnew(sub3[2]);
	third = ft_lstnew(sub3[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	{
		new = ft_lstnew(sub3[0]);
		ft_lstadd_front(&header, new);
		if (new)
		{
			t = 0;
	...
	header = ft_lstnew(&sub4[1]);
	second = ft_lstnew(&sub4[2]);
	third = ft_lstnew(&sub4[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	{
		new = ft_lstnew(&sub4[0]);
		ft_lstadd_front(&header, new);
		if (new)
		{
			t = 0;
	...
	header = ft_lstnew(&sub5[1]);
	second = ft_lstnew(&sub5[2]);
	third = ft_lstnew(&sub5[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	{
		new = ft_lstnew(&sub5[0]);
		ft_lstadd_front(&header, new);
		if (new)
		{
			t = 0;
	...
	header = ft_lstnew(sub6[1]);
	second = ft_lstnew(sub6[2]);
	third = ft_lstnew(sub6[3]);
	header->next = second;
	second->next = third;
	if (sigsetjmp(jump_buffer, 1) == 0)
	{
